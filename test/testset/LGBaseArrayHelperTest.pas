...
procedure TBaseArrayHelperTest.IsSuffixTest;
var
  a: TIntArray = nil;
  b: TIntArray = nil;
begin
...
procedure TBaseArrayHelperTest.IsSubSequence;
var
  a: TIntArray = nil;
  b: TIntArray = nil;
begin
...
procedure TBaseArrayHelperTest.LisI;
begin
...
procedure TBaseArrayHelperTest.LisI2;
const
  TestCount = 100;
  TestLen   = 100;
  TestRange = 1001;
    ...
    begin
      ...
      for Idx in s do
        begin
          ...
          AssertFalse(TIntHelper.IsStrictAscending(aLis));
          ts.Exclude(Idx);
        end;
    end;
end;

procedure TBaseArrayHelperTest.IsPermutation;
var
