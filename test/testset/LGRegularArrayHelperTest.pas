...
procedure TRegularArrayHelperTest.IsPrefixTest;
var
  a: TIntArray = nil;
  b: TIntArray = nil;
begin
  AssertFalse(TIntHelper.IsPrefix(a, b, @IntCmp));
  ...
  a := [1,2,3];
  AssertTrue(TIntHelper.IsPrefix(a, b, @IntCmp));

  a := [1,2];
  AssertTrue(TIntHelper.IsPrefix(a, b, @IntCmp));
end;

procedure TRegularArrayHelperTest.IsSuffixTest;
var
  a: TIntArray = nil;
  b: TIntArray = nil;
begin
  AssertFalse(TIntHelper.IsSuffix(a, b, @IntCmp));
  ...
  a := [1,2,3];
  AssertTrue(TIntHelper.IsSuffix(a, b, @IntCmp));
...
procedure TRegularArrayHelperTest.IsSubSequence;
var
  a: TIntArray = nil;
  b: TIntArray = nil;
begin
...
procedure TRegularArrayHelperTest.LisI;
begin
...
procedure TRegularArrayHelperTest.LisI2;
const
  TestCount = 100;
  TestLen   = 100;
  TestRange = 1001;
...
procedure TRegularArrayHelperTest.IsPermutation;
var
...
procedure TRegularArrayHelperTest.SelectDistinctTest;
var
  a: TIntArray = nil;
  b: TIntArray;
begin
