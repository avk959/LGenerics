...
test files for JTD come from https://github.com/jsontypedef/json-typedef-spec/tree/master/tests;
test files for JSONPath come from https://github.com/jsonpath-standard/jsonpath-compliance-test-suite;