...
{ TGWeightHelper.TBbTspHelper.TMinData }
...
function TGWeightHelper.TBbTspHelper.ExecuteApprox(const m: TWeightMatrix; aEps: Double; aIsSymm: Boolean;
  var aTour: TIntArray): TWeight;
var
  Cols, Rows: array of Integer;
  I: Integer;
begin
