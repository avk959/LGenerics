...
//PDO
  ...
  SEUnexpectMPackTokenFmt  = 'Expected MsgPack token kind "%s", but got "%s"';
  ...
  SEMPackRangeErrorFmt     = 'MsgPack value out of %s range(%d)';
  SEMPackSetSizeErrorFmt   = 'MsgPack binary does not match %s size(%e)';
  ...
  SEMPackArrSizeMismatchFmt= 'MsgPack array size does not match the size of static PDO array(%d)';
